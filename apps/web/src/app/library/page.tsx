  ...
  return (
    <main className="mx-auto flex h-full min-h-0 w-full max-w-[1180px] gap-6 overflow-hidden px-4 pb-6 pt-2 sm:px-6 lg:px-8">
      <section className="flex min-h-0 min-w-0 flex-1 flex-col xl:max-w-[760px]">
        <header className="relative z-40 -mx-4 mb-4 flex shrink-0 items-center justify-between gap-3 border-b border-border bg-background/95 px-4 pb-3 pt-0.5 backdrop-blur sm:-mx-6 sm:mb-5 sm:px-6 sm:pb-4 sm:pt-1 lg:-mx-8 lg:px-8">
